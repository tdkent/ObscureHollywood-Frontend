				...
				<div className="w-full h-full bg-black/10 backdrop-blur-xs lg:backdrop-blur-xs">
					<div className="pt-40 relative flex flex-col h-full gap-14">
						<h1 className="flex flex-col gap-4 px-6 text-[40px] font-bodini-moda italic font-bold leading-12">
							<span className="block animate-fade-in text-white">
								Neglected films.
							</span>
							<span className="block animate-fade-in animation-delay-300 text-white">
								Stars of the past.
							</span>
							<span className="block animate-fade-in animation-delay-600 bg-linear-to-r from-gold to-gold-light bg-clip-text text-transparent">
